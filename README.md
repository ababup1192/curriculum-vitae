...
学部生時代に関数型言語Haskellに出会い、可読性の高いコード・障害が起きにくいコード・汎用性の高いコードを強く意識することになりました。ただ独りよがりな偏った技術の向上では、いずれ共同で開発するメンバーとの意識・スキルのズレが生じると思い、なるべくアウトプットも意識して習得技術を伝えていくことでスキルの平坦化に努めました。また、後進を意識して教育することで自己の練度を高め、正確に技術を伝達する術を磨いていきました。結果として、プロジェクトや研究開発を円滑に進めることができます。(ウンコ文章・・・、もうちょい熟考)
